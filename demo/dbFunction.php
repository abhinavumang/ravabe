...
session_start();
 	class dbFunction {
		...
		public function UserRegister($username, $emailid, $password){
                ...
                $qr = mysql_query("INSERT INTO users(username, emailid, pwd) values('".$username."','".$emailid."','".$password."')");
				//$qr = mysql_query("INSERT INTO users(username, emailid, pwd) values('".$username."','".$emailid."','".$password."')") or die(mysql_error());
